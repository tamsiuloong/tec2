...
public class TestContentCollect {
	...
	private static String testMyCollectContent(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/content/mycollect.jspx";
	...
	private static String testCollectContent(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/content/collect.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String sessionKey="53351580CCD22F3E942F053036C5F1BB";
