...
public abstract class BaseContent  implements Serializable {
	...
	private java.util.Set<com.jeecms.cms.entity.main.ContentDoc> contentDocSet;
	...
	private java.util.Set<com.jeecms.core.entity.CmsWorkflowEvent> eventSet;
	...
	public java.util.Set<com.jeecms.cms.entity.main.ContentDoc> getContentDocSet() {
		return contentDocSet;
	}

	public void setContentDocSet(
			java.util.Set<com.jeecms.cms.entity.main.ContentDoc> contentDocSet) {
		this.contentDocSet = contentDocSet;
	}
	...
	public java.util.Set<com.jeecms.core.entity.CmsWorkflowEvent> getEventSet() {
		return eventSet;
	}

	public void setEventSet(
			java.util.Set<com.jeecms.core.entity.CmsWorkflowEvent> eventSet) {
		this.eventSet = eventSet;
	}

	public java.util.Set<com.jeecms.cms.entity.main.ContentShareCheck> getContentShareCheckSet() {
		return contentShareCheckSet;
	}

	public void setContentShareCheckSet(
			java.util.Set<com.jeecms.cms.entity.main.ContentShareCheck> contentShareCheckSet) {
